...
class YOLOv8_ObjectCounter(YOLOv8_ObjectDetector):
    def __init__(self, model_file='yolov8l.pt', labels=None, classes=[0, 1, 2, 3, 5, 7], conf=0.4, iou=0.45, track_max_age=45, track_min_hits=2, track_iou_threshold=0.4):
    ...
    def predict_video(self, frame_provider, output_file_path, frame_interval=1.0, verbose=True):
        tracker = sort.Sort(
        ...
        def process_frame(frame):
            #frame_resized = cv2.resize(frame, (960, 540))  # Resize frame for faster processing
